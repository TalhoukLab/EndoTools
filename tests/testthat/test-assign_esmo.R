...
test_that("esmo2020 works", {
  ...
  expect_equal(sum(emdb$esmo2020 == "high", na.rm = TRUE), 349)
...
test_that("esmo2020 with eclass works", {
  ...
  expect_equal(sum(emdb$esmo2020 == "high", na.rm = TRUE), 341)
...
test_that("esmo2020 with residual disease works", {
  ...
  expect_equal(sum(emdb$esmo2020 == "intermediate", na.rm = TRUE), 107)
  expect_equal(sum(emdb$esmo2020 == "high-intermediate", na.rm = TRUE), 134)
  expect_equal(sum(emdb$esmo2020 == "high", na.rm = TRUE), 309)
